        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl bg-[#FFFFFF] p-6 shadow-lg shadow-[#4A4A4A]/5">
            ...
            {discountCode && discountPercent > 0 && (
              <>
                <p className="mt-2 text-xs uppercase tracking-[0.3em] text-[#A5B867]">
                  Discount {discountCode} ({discountPercent}%)
                </p>
                <p className="text-sm text-[#666666]">- ?{discountAmount.toLocaleString("en-IN")}</p>
                <p className="mt-1 text-lg font-semibold text-[#4A4A4A]">
                  Total after discount: ?{discountedTotal.toLocaleString("en-IN")}
                </p>
              </>
            )}
            <button
