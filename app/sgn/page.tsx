      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          <div>
            ...
            <CardDescription>
              Enter your email and password to continue. We will email you a one-time code to confirm it is
              really you.
            </CardDescription>
          </div>
          <CardAction>
            <Button asChild variant="link" size="sm">
              <Link href="/sgp">Already have an account?</Link>
            </Button>
          </CardAction>
        </CardHeader>
        <CardContent>
          {step === "collect" ? (
            <form className="flex flex-col gap-6" onSubmit={handleCreateAccount}>
              ...
              <div id="clerk-captcha" data-clerk-captcha className="text-xs text-muted-foreground" aria-hidden />
